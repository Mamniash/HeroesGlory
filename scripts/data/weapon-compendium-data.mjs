...
import { WEAPON_EPIC_TABLES } from '../../module/helpers/weapon-epic-tables.mjs';
...
// Эпик-таблицы категорий — единый источник в коде системы
// (module/helpers/weapon-epic-tables.mjs): из него же берёт таблицу
// стартовое оружие в окне создания героя. Стрелковое оружие эпик-таблицы
// не имеет вовсе (§5.4/§8.1) — там пустой массив, ровно initial-значение
// схемы; roll-actions.mjs и так форсирует epicTable = null для "ranged".
const EPIC_TABLES = WEAPON_EPIC_TABLES;
